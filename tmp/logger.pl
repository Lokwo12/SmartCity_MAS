...
evi(start):-retractall(started),assert(started),retractall(log_store(_124193,_124195,_124197,_124199)),retractall(recent_log(_124213,_124215)),write('=== [LOGGER] Central logger online ==='),nl.

a(should_print(_124079)):-statistics(walltime,[_124093,_124097]),dedup_window_ms(_124109),recent_log(_124079,_124121),_124093-_124121<_124109,!,false.

a(should_print(_124009)):-statistics(walltime,[_124023,_124027]),retractall(recent_log(_124009,_124045)),assert(recent_log(_124009,_124023)),true.
...
log_comm(_123849,_123851,_123853):-comm_trace(on),!,write(comm),write(_123849),write(from),write(_123853),write(payload),write(_123851),nl.

log_comm(_123831,_123833,_123835).

safe_told(_123793,_123795):-current_predicate(told/2)->told(_123793,_123795);true.

safe_told(_123739,_123741,_123743):-current_predicate(told/3)->told(_123739,_123741,_123743);_123743=0.

safe_tell(_123691,_123693,_123695):-current_predicate(tell/3)->tell(_123691,_123693,_123695);true.
...
log_comm(_123579,_123581,_123583).
...
receive(send_message(_123401,_123403)):-safe_told(_123403,send_message(_123401)),call_send_message(_123401,_123403).

send(_123345,send_message(_123351,_123353)):-safe_tell(_123345,_123353,send_message(_123351)),send_m(_123345,send_message(_123351,_123353)).
...
call_send_message(_121751,_121753):-nonvar(_121751)->log_comm(dispatch,_121751,_121753),(nonvar(_121753),_121753\=self,catch(send_message(_121751,_121753),_121817,fail);catch(send_message(_121751,_121845),_121837,fail);catch(call(eve(_121751)),_121857,fail);catch(call(evi(_121751)),_121879,fail);true);true.
...
trigger_inform_handlers(var_X,var_M,var_Ag):-catch(call(eve(inform_E(var_X,var_Ag))),_120587,true),catch(call(eve(inform_E(var_X,var_M,var_Ag))),_120615,true),catch(call(eve(inform_E(var_X))),_120645,true),catch(call(eve(inform_(var_X,var_Ag))),_120671,true),catch(call(eve(inform_(var_X,var_M,var_Ag))),_120699,true),catch(call(eve(inform_(var_X))),_120729,true),catch(call(eve(eve(inform_(var_X,var_Ag)))),_120755,true),catch(call(eve(eve(inform_(var_X,var_M,var_Ag)))),_120787,true),catch(call(eve(eve(inform_(var_X)))),_120815,true).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_120351,var_Ontology,_120355),_120345),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_120389)),a(message(var_Ag,propose(var_A,[_120389],var_AgI))),retractall(ext_agent(var_Ag,_120427,var_Ontology,_120431)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_120225,var_Ontology,_120229),_120219),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_120295,var_Ontology,_120299)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_120113,var_Ontology,_120117),_120107),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_120169,var_Ontology,_120173)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_119677),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_119711),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_119493).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_119341),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_119289),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_119165,_119167)),clause(agente(_119187,_119189,_119191,var_S),_119183),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_118959,_118961,_118963,var_S),_118955),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_119059,[]),repeat,read(_119059,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_119059).

send_msg_learn(var_T,var_A,var_Ag):-a(message(var_Ag,confirm(learn(var_T),var_A))).

told(_118889,send_message(_118895)):-true.

told(_118865,inform(_118873,_118875),70):-true.

told(_118843,inform(_118851),70):-true.

told(_118823,refuse(_118829)):-true.

told(_118801,refuse(_118807,_118809)):-true.

tell(_118779,_118781,send_message(_118787)):-true.

tell(_118757,_118759,refuse(_118765)):-true.

tell(_118733,_118735,refuse(_118741,_118743)):-true.

tell(_118709,_118711,inform(_118717,_118719)):-true.

tell(_118687,_118689,inform(_118695)):-true.

meta(_118659,_118659,_118663):-nonvar(_118659),!.
